...
"""Mock Slack server for feature tests."""
...
class SlackHandler(BaseHTTPRequestHandler):
    """
    Handler for requests to the mock Slack server.
    """
    ...
    def determine_response(self, form=None):
        ...
        """
        # TODO: url unquoting
        if form and 'version 200 of myapp on' in form['text']:
            return 403
        if form and 'version 500 of myapp on' in form['text']:
            return 'No response'
        return 200
...
class SlackServer(HTTPServer, object):
    """
    ...
    def __init__(self, addr, *args, **kwargs):
        ...
        HTTPServer.__init__(self, addr, SlackHandler, *args, **kwargs)
