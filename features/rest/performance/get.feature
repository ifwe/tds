Feature: REST API performance GET
    ...
    Scenario: get with no data
        When I query GET "/performance"
        Then the response code is 200
        And the response object contains attributes packages,tier_deployments,host_deployments,deployments
    ...
    Scenario: get with data
        ...
        Then the response code is 200
        And the response object contains attributes packages,tier_deployments,host_deployments,deployments
        And the response object conforms to the performance expectation
