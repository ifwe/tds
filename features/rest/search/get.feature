...
Feature: REST API search GET
    ...
    Scenario: pass unknown param in query
        ...
        And the response contains errors:
            | location  | name      | description                                                                                                                                                                                               |
            | query     | status    | Unsupported query: status. Valid parameters: ['cab', 'cage', 'elevation', 'dc_id', 'distribution', 'environment_id', 'id', 'limit', 'name', 'rack', 'select', 'spec_id', 'start', 'state', 'tier_id']. |
